export default {
    ...
    authentification: {
        ...
        confirm_password: 'Confirmé mot de passe',
        mail: 'Adresse mail',
    ...
    verification: {
        ...
        confirm_password_error: 'Mots de passe non identique',
        confirm_password_msg: 'Les deux mots de passe ne correspondent pas',
    },
    scan: {
        scan: 'Scan',
